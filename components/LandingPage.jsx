          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="bg-green-600 text-black font-semibold text-xl px-6 py-2" onClick={onShowAuth}>
                  Start as Farmer
                </Button>
                <Button size="lg" className="bg-blue-600 text-black font-semibold text-xl px-6 py-2" onClick={onShowAuth}>
                  Start as Buyer
                </Button>
              </div>
            </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-secondary text-xl text-secondary-foreground">
              🚀 Platform Features
            </Badge>

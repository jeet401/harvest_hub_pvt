                ...
                <TableBody>
                  {users.map((user) => (
                    <TableRow key={user.id}>
                      ...
                      <TableCell>
                        <div className="flex space-x-2">
                          <Button variant="ghost" size="sm" onClick={() => alert('Edit user coming soon!')}>
                            <Edit className="w-4 h-4" />
                          </Button>
                          <Button variant="ghost" size="sm" onClick={() => setUsers(users.filter(u => u.id !== user.id))}>
                        ...
                        <div className="flex space-x-2">
                          ...
                          <Button variant="ghost" size="sm" onClick={() => {
                            if (cert.documents && cert.documents.length > 0) {
                              window.open(cert.documents[0], '_blank');
                            } else {
